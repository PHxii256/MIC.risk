...
namespace MIC.risk.Controllers
{
    ...
    public class RiskSubcategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById(long id)
        {
            ...
            if (risk == null)
            {
                return NotFound(new { Message = $"Risk subcategory with ID {id} was not found." });
            }
        ...
        public async Task<IActionResult> GetRiskSubcategoryByCategory(string category)
        {
            try
            {
                ...
                if (!res.Any())
                {
                    return NotFound(new { Message = $"Risk subcategory with specified category '{category}' was not found." });
                }
